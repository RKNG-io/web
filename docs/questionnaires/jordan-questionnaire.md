...
> **You're doing it. Let's make it easier.**
>
> You didn't wait for permission. You figured it out, found clients, made it work.
>
...
*What they've actually built. Celebrate it first.*
...
### Q2: What's your business?
*(Single choice + "Other" with free text)*
...
> Seriously. You've built something. Name it.

---

## 3. The Mess

*No judgement. Just honesty about what's held together with hope.*
...
- Slow response times
- Unclear pricing or awkward money conversations
- No formal contract or scope
...
*What does "professional" look like to them?*

### Q14: When you imagine your business running properly, what's different?
*(Multi-select)*

- Clients find me, I don't chase them
- I know my prices and don't apologise for them
- I have contracts that protect me
- Invoices go out on time and get paid
- Booking is easy, no back-and-forth
- I have boundaries and clients respect them
- My website makes me proud
- I have systems I can rely on
- I'm not reinventing everything each project
- I feel like a business owner, not a freelancer

### Q15: What's the ONE thing that would make the biggest difference right now?
*(Single choice)*

- A website that actually works for me
...
> A peer, a competitor, someone in your field. What do they have that you want?
...
### Q20: Imagine it's 6 months from now. What's true about your business that isn't true today?
*(Free text)*

### Q21: What's the thing you most need help with?
*(Free text, 1 sentence)*

### Q22: Anything else I should know?
*(Free text, optional)*
...
>
> Most people never get this far. They talk about it, think about it, wait for the right moment.
>
> You didn't wait. You figured it out.
>
...
| Input | Used For |
|-------|----------|
| Business type + duration (Q1, Q2) | Tailor recommendations |
| Income reality (Q3) | Gauge stability, pricing advice |
| What's working (Q4, Q5) | Lead with strengths in report |
| The mess (Q7, Q8, Q9) | Priority fixes, checklist items |
| The cost (Q10, Q11, Q12, Q13) | "Cost of inaction" calculation |
| Vision of "professional" (Q14, Q15) | Anchor recommendations to their goals |
| Time + budget (Q17, Q18) | DIY vs. done-for-you weighting |
| Resistance (Q19) | Tone of report, address objections |
| 6-month vision (Q20) | Reflect back, emotional hook |
| One thing (Q21) | Lead recommendation |

---

## Conditional Logic

**Based on Q2 (business type):**
- Load type-specific checklist items
- Add relevant follow-up questions (portfolio for creatives, client portal for consultants, etc.)

**Based on Q7 (duct tape areas):**
- If "pricing" selected → add follow-up about how they currently price
- If "contracts" selected → ask if they've ever had a scope creep nightmare
- If "boundaries" selected → ask what they wish they could say no to
