...
**Reckoning helps business owners stop working for their business and start having their business work for them.**

We're not an agency. We're not a course. We're the bridge between the life you're living and the one you've been waiting to build.
...
Questionnaire (15 min) → Personalised Report → Clarity on what's blocking them
                                              ...
                                              → Option to DIY or get help
```

**Why free?**
- Zero friction to value
- Builds trust before asking for money
- Captures qualified leads with real context
...
**Why offer this?**
- Respects people who've already decided
...
- "Chasing invoices feels awkward"

**What unlocks them:**
- Automations that sound like them
- Systems that give time back
- Growth without hiring

### Architect
**Where they are:** Successful, but capped. The business can't run without them.

**What's blocking them:**
- "I am the bottleneck"
- "I need to hire to scale"
- "I can't step back"

**What unlocks them:**
- Operations that don't depend on them
...
1. **Kickoff:** Brief async call or Loom exchange
2. **Build:** We build using templates + AI + expertise
3. **Review:** They review, we refine
4. **Handover:** Loom walkthrough + documentation
5. **Support:** 14-day support window included

**Key principle:** They own everything. No lock-in. No dependency.

---

## AI Integration

AI is built into delivery, not sold as a gimmick:

| Where AI Shows Up | What It Does |
|-------------------|--------------|
...
2. INTAKE
   Path A: Full questionnaire (15 min) → Personalised report
   Path B: Simple intake (5 min) → Quote

3. RECKONING (Path A only)
   Personalised report:
...
### vs. DIY
- **DIY is:** Overwhelming, generic, no prioritisation
- **We are:** Personalised, prioritised, done-with-you

### vs. Freelancers
- **Freelancers:** Execute briefs, no diagnosis
- **We:** Diagnose first, then implement what matters

**Positioning:** "The clarity of a coach. The speed of a freelancer. The quality of an agency. At a price that makes sense."
